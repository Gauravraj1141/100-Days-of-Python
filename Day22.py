...
# print(dir(skillf)) # it is dir we can know by this all
# the function's features that what we can do this class fuction
# and what is in this class all details about the function we know by
# this "dir"
